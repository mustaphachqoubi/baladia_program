...
export const Notifications = () => {
  ...
  const getArrivee = async () => {
    try {
      const arrivee = await axios.get(
        "https://baladia-program.onrender.com/arrivee/delay"
      );
      const depart = await axios.get(
        "https://baladia-program.onrender.com/depart/delay"
      );
  ...
  async function handleAnswerDocument(documentId, dataCategory) {
    ...
    try {
      await axios.patch(
        `https://baladia-program.onrender.com/${endpoint}/delay/${documentId}`
      );
  ...
  return (
    <>
      <div className="bg-red-500 text-white font-bold p-2 w-full my-5 text-center">
        {" "}
        You have a delay in arrivee data
      </div>
          ...
          <TableHead>
            <TableRow>
              <TableCell align="center" sx={{ fontWeight: "bold" }}>
                Date d'arrivée et N° d'ordere annuel
              </TableCell>
              <TableCell align="center" sx={{ fontWeight: "bold" }}>
                Date et N° de la lettre d'arrivée
              </TableCell>
              <TableCell align="center" sx={{ fontWeight: "bold" }}>
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <input
                        onClick={(e) =>
                          e.target.value === "on" &&
                          handleAnswerDocument(arrivee._id, "arrivee")
                        }
                        type="checkbox"
                      />
                    </TableCell>
      ...
      <div className="bg-red-500 text-white font-bold p-2 w-full my-5 text-center">
        {" "}
        You have a delay in depart data
      </div>
                  ...
                  >
                    ...
                    <TableCell align="center">{d.answerdate}</TableCell>
                      ...
                      <input
                        onClick={(e) =>
                          e.target.value === "on" &&
                          handleAnswerDocument(depart._id, "depart")
                        }
                        type="checkbox"
                      />
                    </TableCell>
